...
describe 'atom feed' do
  ...
  it 'should have an ID element' do
    body.should have_tag('/feed/id', 'tag:russbrooks.com,2009:/')
  end

  it 'should have an alternate link element' do
    body.should have_tag("/feed/link[@rel=alternate][@href='http://russbrooks.com']")
  end

  it 'should have a self link element' do
    body.should have_tag(
        "/feed/link[@rel=self][@href='http://russbrooks.com/articles.xml']")
  end

  it 'should have title and subtitle' do
    body.should have_tag('/feed/title[@type=text]', 'Russell Brooks')
    body.should have_tag('/feed/subtitle[@type=text]', 'Circuitous Sinuosity')
  end

  it 'should include the author details' do
    body.should have_tag('/feed/author/name', 'Russell Brooks')
    body.should have_tag('/feed/author/uri', 'http://russbrooks.com')
    body.should have_tag('/feed/author/email', 'me@russbrooks.com')
  end
  ...
  describe 'for article' do
    ...
    it 'should link to the HTML version' do
      url = 'http://russbrooks.com/#{@article.path}'
      body.should have_tag("entry/link[@href='#{url}'][@rel=alternate][@type='text/html']")
    end

    it 'should define unique ID' do
      body.should have_tag("entry/id', 'tag:russbrooks.com,2009-01-11:#{@article.abspath}")
    end
